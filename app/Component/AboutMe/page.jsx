        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="space-y-6">
            <p className="text-base text-lg leading-relaxed text-justify">
              Hello! I&apos;m{" "}
              <span className="font-semibold text-secondary bg-blue-50 dark:bg-blue-950 px-1 rounded">
                Md. Salauddin Khan
              </span>
              , a passionate web developer with experience in building
              responsive, modern, and user-friendly websites. I specialize in{" "}
              <span className="font-semibold text-gray-900 dark:text-gray-400 bg-yellow-50 dark:bg-green-900 px-1 rounded">
                Next.js
              </span>
              ,
              <span className="font-semibold text-gray-900 dark:text-gray-400 bg-blue-50 dark:bg-blue-950 px-1 rounded">
                {" "}
                React
              </span>
              , and
              <span className="font-semibold text-gray-900 dark:text-gray-400 bg-cyan-50 dark:bg-cyan-950 px-1 rounded">
                {" "}
                Tailwind CSS
              </span>
              .
            ...
            <p className="text-base text-lg leading-relaxed text-justify">
              I love turning ideas into beautiful, functional web applications.
          ...
          <div className="flex flex-wrap gap-6 py-4">
            <div className="flex items-center gap-2 cardBg-secondary px-4 py-2 rounded-lg shadow-sm border border-gray-100">
              ...
              <span className="text-gray-700 dark:text-gray-800 font-medium">
                Frontend
              </span>
            </div>
            <div className="flex items-center gap-2 cardBg-secondary px-4 py-2 rounded-lg shadow-sm border border-gray-100">
